...
const features = [
  ["🎥", "Live classes", "A real video room — camera, screen-share & open a doc, with the lecturer in control."],
  ["🔗", "Invite-link access", "Students can't see or join a class until they open your share link. You decide who's in."],
  ["✅", "Attendance, automatic", "Joining the live class marks students present. Export the roll (with matric numbers) as CSV."],
  ["📊", "Polls & quizzes", "Prepare them ahead, then start them live mid-class. Watch the results come in real time."],
  ["📁", "Materials", "Upload slides, notes & documents — students download them anytime, on any connection."],
  ["🛡️", "Integrity checks", "See if a student is on multiple screens or has left the class screen — live, on your roster."],
];

const steps = [
  ["Schedule & share", "Create a class, then send students its private invite link."],
  ["Go live", "Start the room — screen-share, mute anyone, take hands, all from your screen."],
  ["Attend & assess", "Attendance is automatic; run a quiz or poll and export the results."],
];
      ...
      <main className="flex-1">
        ...
        <section className="border-t border-line bg-paper-2/40">
          <div className="mx-auto max-w-6xl px-5 py-14 sm:py-20">
            ...
            <h2 className="mt-2 text-center font-display text-3xl font-semibold sm:text-4xl lg:text-left">Built for how UniAbuja actually teaches</h2>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="card p-7">
              ...
              <ul className="mt-4 space-y-2 text-sm text-ink-soft">
                <li>✓ Screen-share & open documents live</li>
                <li>✓ Mute anyone, take raised hands</li>
                <li>✓ Start prepared quizzes &amp; polls mid-class</li>
            ...
            <div className="card p-7">
              ...
              <ul className="mt-4 space-y-2 text-sm text-ink-soft">
                ...
                <li>✓ Download every slide &amp; note</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-5 pb-16 sm:pb-24">
          <div className="card flex flex-col items-center gap-5 p-8 text-center sm:p-12">
            ...
            <p className="max-w-md text-ink-soft">Create an account as a lecturer or student and run your first live class in minutes.</p>
  ...
  return (
    <div className="card mx-auto max-w-md overflow-hidden p-3 sm:p-4">
      ...
      <div className="mt-2 flex flex-wrap gap-1.5">
        {["🎙 Mic", "📹 Cam", "🖥 Share", "🔇 Mute all", "📋 Quiz"].map((c) => (
